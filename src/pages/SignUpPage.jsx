...
function SignUpPage() {
  ...
  const url = 'https://667ba97dbd627f0dcc9358df.mockapi.io/users';
            ...
            <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
              <form>
                ...
                <div className="flex flex-row items-center justify-center lg:justify-start">
                  ...
                  <button
                    type="button"
                    className="mx-1 h-9 w-9 rounded-full bg-primary  leading-normal text-white  hover:bg-gray-500 "
                  >
                    {/* <!-- Facebook --> */}
                    <svg
                  ...
                  <button
                    type="button"
                    className="mx-1 h-9 w-9 rounded-full bg-primary uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca]  hover:bg-gray-500 "
                  >
                    {/* <!-- Twitter --> */}
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="flex gap-5 flex-col">
                  ...
                  <label className="input input-bordered flex items-center gap-2">
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M10 11a5 5 0 100-10 5 5 0 000 10zM0 18a18 18 0 1018 0H0zm10-3a6 6 0 100-12 6 6 0 000 12z"
                        clipRule="evenodd"
                      />
                    </svg>
                    <input
                  ...
                  {errors.name && (
                    <p className="text-red-500  leading-none">{errors.name}</p>
                  )}
                  ...
                  {errors.email && (
                    <p className="text-red-500 leading-none">{errors.email}</p>
                  )}
